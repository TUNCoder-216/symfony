 ...
 */
final class Version20240501081857 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE gestion_cours (id INT AUTO_INCREMENT NOT NULL, numero_biblio INT NOT NULL, titre VARCHAR(255) NOT NULL, pdf VARCHAR(255) NOT NULL, nombre_pages INT NOT NULL, video VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP TABLE gestion_cours');
